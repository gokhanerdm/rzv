...
- `app/components/` — ortak bileşenler (liste satırı, çift tıkla düzenleme, üst bar, menü, tarih seçici)
...
Yeni ortak bileşen eklerken her sayfa kendi yerine koyar; tüm ekranlara tek bir sabit katman olarak eklenmez — daha önce öyle kurulan bir bileşende üst üste binme hatası üç kez çıktı.
