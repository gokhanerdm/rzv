  ...
  const sayaclar = (dikey: boolean) => (
    <div style={dikey
      ...
      : { marginBottom: 10, flexShrink: 0, fontSize: 12.5, color: inkSoft, display: "flex", alignItems: "center", gap: 28 }}>
          ...
          <span style={{ fontWeight: 600, color: "var(--ink)", minWidth: dikey ? 36 : undefined, textTransform: dikey ? undefined : "uppercase" }} title="Yemek salonu. Geceye kalanlar buradan değil, gece sayacından düşer.">Yemek</span>
          ...
          {eglenceAktif && (bistroSayisi > 0 || ayaktaKapasite > 0) && (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 2, width: dikey ? "100%" : undefined, minWidth: 0 }}>
            <div style={{ display: "flex", alignItems: dikey ? "center" : "baseline", gap: dikey ? 3 : 8, flexWrap: dikey ? "wrap" : "nowrap", maxWidth: "100%", minWidth: 0 }}>
              <span style={{ fontWeight: 600, color: "var(--ink)", minWidth: dikey ? 36 : undefined, textTransform: dikey ? undefined : "uppercase" }} title="Gece salonundaki bistrolar. Geceye kalan misafirler buradan düşer; bir bistro en fazla beş kişi alır.">Gece</span>
            <div style={{ display: "flex", alignItems: dikey ? "center" : "baseline", gap: dikey ? 3 : 12, flexWrap: dikey ? "wrap" : "nowrap", minWidth: 0 }}>
              <div style={{ display: "grid", gridTemplateColumns: dikey ? "minmax(29px, auto) minmax(18px, auto)" : "auto auto", columnGap: dikey ? 3 : 5, rowGap: 2, alignItems: "baseline", flexShrink: 0 }}>
                <span>RZV</span>
          ...
          {eglenceAktif && ayaktaKapasite > 0 && (
            <div style={{ display: "flex", alignItems: dikey ? "center" : "baseline", gap: dikey ? 3 : 8, flexWrap: dikey ? "wrap" : "nowrap", maxWidth: "100%", minWidth: 0 }}>
              <span style={{ fontWeight: 600, color: "var(--ink)", minWidth: dikey ? 36 : undefined, textTransform: dikey ? undefined : "uppercase" }} title="Bistrolar dolduğunda masasız alınan misafirler buradan düşer.">Ayakta</span>
            <div style={{ display: "flex", alignItems: dikey ? "center" : "baseline", gap: dikey ? 3 : 12, flexWrap: dikey ? "wrap" : "nowrap", minWidth: 0 }}>
              <div style={{ display: "grid", gridTemplateColumns: dikey ? "minmax(29px, auto) minmax(18px, auto)" : "auto auto", columnGap: dikey ? 3 : 5, rowGap: 2, alignItems: "baseline", flexShrink: 0 }}>
                <span>RZV</span>
          ...
          {locaMasalari.length > 0 && (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 2, width: dikey ? "100%" : undefined, minWidth: 0 }}>
            <div style={{ display: "flex", alignItems: dikey ? "center" : "baseline", gap: dikey ? 3 : 8, flexWrap: dikey ? "wrap" : "nowrap", maxWidth: "100%", minWidth: 0 }}>
              <span style={{ fontWeight: 600, color: "var(--ink)", minWidth: dikey ? 36 : undefined, textTransform: dikey ? undefined : "uppercase" }} title="Locanın sabit kişi sayısı yok — aynı locaya 2 kişi de girer 10 kişi de. Bu yüzden kapasite yazılmıyor. Loca otomatik dağıtılmaz, elle verilir.">Loca</span>
            <div style={{ display: "flex", alignItems: dikey ? "center" : "baseline", gap: dikey ? 3 : 12, flexWrap: dikey ? "wrap" : "nowrap", minWidth: 0 }}>
              <div style={{ display: "grid", gridTemplateColumns: dikey ? "minmax(29px, auto) minmax(18px, auto)" : "auto auto", columnGap: dikey ? 3 : 5, rowGap: 2, alignItems: "baseline", flexShrink: 0 }}>
                <span>RZV</span>
