-- Kişi kartı: "Tercih" listesine yemek/içki tercihi eklendi (Gökhan, 2026-08-07) — bunlar
-- Rezervasyon/Masa gibi istatistikten çıkmıyor, personelin elle kaydettiği gerçek tercihler.
alter table kisi_kartlari add column if not exists yemek_tercihi text;
alter table kisi_kartlari add column if not exists icki_tercihi text;
