-- Aynı numarayla farklı isimlerle gelinmişse kartta bunu göster (Gökhan, 2026-08-15:
-- "kart yine tek kalsın ama kartta bu numarayla gelenler yazsın"). Kart bölünmüyor,
-- numara yine kimlik; personel isim farkını görüp kararı kendisi veriyor.
-- Tek değişiklik: kisi_karti_getir'e kullanilan_isimler çıktısı eklendi.
...
begin
  ...
  select
    ...
    -- Bu numarayla hangi isimlerle gelinmiş. En çok kullanılan isim başta.
